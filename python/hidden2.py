...
plt.plot(b,d,'g',label="test_accuracy")
...
for i in range(0,51):
    b.append(i*100)
plt.plot(b,a,'r',label="SGD")
plt.plot(b,c,'g',label="AdagradOptimizer") 
plt.plot(b,d,'b',label="MomentumOptimizer") 
plt.legend(loc='lower right')
plt.xlabel('Epoch')
plt.ylabel('test accuracy')
plt.title('test accuracy for initial learning rate 0.3')
plt.tight_layout()
plt.show()
